...
class Libgen:
    ...
    def __search(self,
        ...
        data = {}
        if ids_list:
            data = self.__get_json(ids_list=ids_list,
    ...
    def __get_ids(self,
        ...
        if r.status_code != 200:
            Util.raise_error(r.status_code, str(r.reason) +
                             ' - ' + str(bsoup(r.text, 'lxml').get_text()))
    ...
    def __get_json(self,
        ...
        raw_data = r.json()
        return self.__format_json(raw_data=raw_data,
                                  ids_list=ids_list,
                                  filters=filters,
                                  return_fields=return_fields)
